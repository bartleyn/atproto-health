...
export function InfraSection({ providers, cdnBreakdown, locations, providerLocations, topPdsList = [], bskyShardCounts, langLocations, topLangs, namespaceLocations, topNamespaces, pdsLangRows, pdsCollectionRows }: InfraSectionProps) {
  ...
  const tableLabel = insetTab === "lang"
    ...
    : insetTab === "namespace"
    ? { title: "Top PDSes by recent users using a non-app.bsky NSID", col: "Users" }
    : selectedProvider
  ...
  return (
    <div className="rounded-lg border border-gray-800 bg-gray-900 p-5">
      ...
      <div className="relative">
        ...
        <div className="hidden md:block absolute bottom-3 left-3 w-60 bg-gray-950/90 border border-gray-700 rounded-lg p-3">
          ...
          {insetTab === "namespace" && hasNamespaceData && (
            <>
              <div className="flex items-center justify-between mb-0.5">
                <p className="text-xs font-medium text-gray-300">NSIDs</p>
              </div>
      ...
      <div className="block md:hidden mt-4 pt-4 border-t border-gray-800">
        ...
        {insetTab === "namespace" && hasNamespaceData && (
          <>
            <p className="text-xs font-medium text-gray-300 mb-1">NSIDs</p>
  ...
  return (
    <div className="mt-6">
      <h3 className="text-sm font-semibold mb-0.5">
        PDSes by &ldquo;{traitLabel}&rdquo; {mode === "lang" ? "language share" : "NSID users"}
      </h3>
      <p className="text-xs text-gray-500 mb-3">
        {mode === "lang"
          ? "Ranked by proportion of active speakers · composition bar shows top-5 language breakdown"
          : "Ranked by unique users · composition bar shows top-5 NSID breakdown"}
      </p>
